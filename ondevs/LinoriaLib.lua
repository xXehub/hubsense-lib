        ...
        if self.Type == 'Toggle' and ToggleLabel and self.Container then
            local function UpdateToggleLabelWidth()
                ...
                if containerWidth and containerWidth > 0 then
                    local padding = 10 -- fine tune inline picker alignment
...
do
    ...
    function Funcs:AddTable(Info)
        assert(Info.Headers, 'AddTable: Missing headers array.')
        ...
        Library:AddToRegistry(TableInner, {
            BackgroundColor3 = 'BackgroundColor';
            BorderColor3 = 'OutlineColor';
        });
        ...
        Library:AddToRegistry(HeaderRow, {
            BackgroundColor3 = 'MainColor';
        });
        ...
        function Table:Clear()
            for _, RowFrame in ipairs(Table.Rows) do
                RowFrame:Destroy();
            end;
            Table.Rows = {};
        ...
        function Table:AddRow(RowData)
            ...
            Library:AddToRegistry(RowFrame, {
                BackgroundColor3 = (#Table.Rows % 2 == 0) and 'BackgroundColor' or function()
                    return Library:GetDarkerColor(Library.BackgroundColor);
                end;
            });
            ...
            ScrollingFrame.CanvasSize = UDim2.new(0, 0, 0, #Table.Rows * 18);
        end;
        
        function Table:SetRows(RowsData)
            Table:Clear();
...
function Library:CreateSecondaryWindow(Config)
    ...
    if Config.OffsetFromParent then
        print('[SecondaryWindow] Custom Offset:', Config.OffsetFromParent.X, Config.OffsetFromParent.Y)
    end
